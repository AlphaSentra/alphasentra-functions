...
def render_efficiency_tab(returns_series, benchmark_returns, holdings_df, prices) -> str:
    """
    ...
    charts['efficiency_metrics_strip'] = generate_efficiency_metrics_strip(returns_series, benchmark_returns)
    ...
    charts['rolling_metrics_table'] = generate_rolling_metrics_table(returns_series, benchmark_returns)
