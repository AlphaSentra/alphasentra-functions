...
app.route('/port/check_cache', methods=['POST'])(port_cache_status) # Keep endpoint but exclude from Function Index
register_route(app, '/SEL', 'Portfolio Investor Selection', sel)
